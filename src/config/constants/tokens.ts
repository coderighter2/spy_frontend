...
export const mainnetTokens = {
  ...
  minitokie: new Token(MAINNET, '0xc6C3Ef889614aF49962Fd56A390e67A0A26c3591', 9, 'TOKIE', 'Mini Tokie', 'https://spy-token.io'),
}
export const testnetTokens = {
  ...
  minitokie: new Token(TESTNET, '0x71a0Ffe70cdEaBe758C64EB49eb261cCfb051E31', 9, 'TOKIE', 'Mini Tokie', 'https://spy-token.io'),
}
