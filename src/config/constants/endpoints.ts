...
export const GRAPH_API_GOVERNANCE_MANUAL = process.env.REACT_APP_GRAPH_API_GOVERNANCE_MANUAL
export const GRAPH_API_SPY_BURN = process.env.REACT_APP_GRAPH_API_SPY_BURN
