...
const DesclaimerModal: React.FC<DesclaimerModalProps> = ({
  ...
  const desclaimers = [
    ...
    t('I understand tokens deposited to the Swap Pool contract are non-recoverable (Regardless of success or failure)'),
    t('I understand fees paid to launch a Swap Pool are non-recoverable'),
    t('I understand that I have to finalize my Swap Pool within 7 days of hitting the hardcap!'),
    t('I am using Smarty Pay as a software tool only and am alone responsible for anything I create on it'),
